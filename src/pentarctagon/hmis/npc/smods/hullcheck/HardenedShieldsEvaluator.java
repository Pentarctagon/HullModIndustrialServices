...
public class HardenedShieldsEvaluator
implements HullModEvaluator
{
	@Override
	public String getId()
	{
		return HullMods.HARDENED_SHIELDS;
	}
	...
	public boolean evaluate(FleetMemberAPI ship, boolean smod)
	{
		...
		// shield efficiency is already decent
		if(variant.getHullSpec().getShieldSpec().getFluxPerDamageAbsorbed() < 0.7f)
		{
			return false;
		}
		return true;
